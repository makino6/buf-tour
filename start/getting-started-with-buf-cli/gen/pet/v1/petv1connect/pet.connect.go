...
const (
	...
	// RPC.
	PetStoreServiceListPetsProcedure = "/pet.v1.PetStoreService/ListPets"
...
var (
	...
	petStoreServiceListPetsMethodDescriptor  = petStoreServiceServiceDescriptor.Methods().ByName("ListPets")
...
func NewPetStoreServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PetStoreServiceClient {
	...
	return &petStoreServiceClient{
		...
		listPets: connect.NewClient[v1.ListPetsRequest, v1.ListPetsResponse](
			...
			connect.WithSchema(petStoreServiceListPetsMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
...
// ListPets calls pet.v1.PetStoreService.ListPets.
...
func (UnimplementedPetStoreServiceHandler) ListPets(context.Context, *connect.Request[v1.ListPetsRequest]) (*connect.Response[v1.ListPetsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("pet.v1.PetStoreService.ListPets is not implemented"))
}
