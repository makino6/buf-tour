...
export class Pet extends Message<Pet> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 5, name: "created_at", kind: "message", T: DateTime },
  ]);
 ...
 */
export class ListPetsRequest extends Message<ListPetsRequest> {
  constructor(data?: PartialMessage<ListPetsRequest>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "pet.v1.ListPetsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListPetsRequest {
    return new ListPetsRequest().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListPetsRequest {
    return new ListPetsRequest().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListPetsRequest {
    return new ListPetsRequest().fromJsonString(jsonString, options);
  }

  static equals(a: ListPetsRequest | PlainMessage<ListPetsRequest> | undefined, b: ListPetsRequest | PlainMessage<ListPetsRequest> | undefined): boolean {
    return proto3.util.equals(ListPetsRequest, a, b);
  }
}
 ...
 */
export class ListPetsResponse extends Message<ListPetsResponse> {
  /**
   * List of pets
   *
  ...
  constructor(data?: PartialMessage<ListPetsResponse>) {
    super();
    proto3.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "pet.v1.ListPetsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "pets", kind: "message", T: Pet, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListPetsResponse {
    return new ListPetsResponse().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListPetsResponse {
    return new ListPetsResponse().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListPetsResponse {
    return new ListPetsResponse().fromJsonString(jsonString, options);
  }

  static equals(a: ListPetsResponse | PlainMessage<ListPetsResponse> | undefined, b: ListPetsResponse | PlainMessage<ListPetsResponse> | undefined): boolean {
    return proto3.util.equals(ListPetsResponse, a, b);
  }
}
